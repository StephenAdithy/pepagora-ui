  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-[81px] w-full bg-white border-b border-gray-200 px-[32px] py-[23px] flex items-center justify-between">
      ...
      <div className="flex items-center space-x-[48px]">
        ...
        <button className="flex items-center font-medium text-[14px] leading-[20px] tracking-[0] text-gray-700 hover:text-red-600">
          <img src={menu} alt="Pepagora menu" className="mr-1" /> All Categories
        </button>
      </div>

      {/* Middle: Search bar */}
      <div className="flex-1 w-[47.32%] max-w-full mx-6">
      ...
      <div className="flex items-center space-x-[12px]">
        ...
        {/* CTA Button */}
        <button className="bg-gray-800 text-white px-4 py-2 rounded-full font-medium text-[14px] leading-[14px] tracking-[0.5px]">
